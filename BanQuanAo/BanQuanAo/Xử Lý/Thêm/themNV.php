	...
	if(isset($_POST["submit_name"])){
		...
		$sdt = $_POST["sdt"];
	      ...
	      require("Connect.php");
			if($conn)
				{   
				    $SQL1= "INSERT INTO user2.NHANVIEN values('$ma_nv','$ho_nv','$ten_nv','$ngaysinh','$diachi','$sdt')";
...
?>			
            ...
            <table width="640px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr height="50">
                	<td class="form"><input type="submit" name="submit_name" value="Thêm Nhân Viên" /> <input type="reset" name="reset_name" value="Làm mới" /></td>
                </tr>
            </table>
            </form>