	...
	if(isset($_POST["submit_name"])){
		...
		$sdt = $_POST["sdt"];
	      ...
	      require("Connect.php");
			if($conn)
				{   
				    $SQL1= "update user1.NCC set TenNCC='$ten_ncc',DiaChiNCC='$dia_chi', SDTNCC = '$sdt' where MaNCC='$ma_ncc'";
...
?>			
            ...
            <table width="640px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr height="50">
                	<td class="form"><input type="submit" name="submit_name" value="Sửa NCC" /> <input type="reset" name="reset_name" value="Làm mới" /></td>
                </tr>
            </table>
            </form>